...
public class GPUImageNormalBlendFilter extends GPUImageTwoInputFilter {
    static String getShaderCode(boolean isPremultiplied) {
        String code = "varying highp vec2 textureCoordinate;\n" +
    ...
    /**
     * optional constructor to create normal blend with result premultiplied or not
     *
     * @param isPremultply either the result should be premultiplied or not
     * @see GPUImageNormalBlendFilter docs
     */
    public GPUImageNormalBlendFilter(boolean isPremultply) {
        super(getShaderCode(isPremultply));
    }
}
